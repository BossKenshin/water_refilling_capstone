...
<div class="container-fluid m-3">
    ...
    <div class="container">
        ...
        <input class="form-control w-25" type="text" id="search" placeholder="Search" style="height:40px;">
    </div>
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="mb-3">
                <label for="cname" class="form-label">Late payments no. of Month/s</label>
